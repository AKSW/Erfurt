...
require_once 'Erfurt/Sparql/Parser/Sparql11update.php';
class Erfurt_Sparql_ParserUpdate11Test extends Erfurt_TestCase
{
    ...
    {
		$parser = new Erfurt_Sparql_Parser_Sparql11update();
		try {
