...
require_once 'Erfurt/Sparql/Parser/Sparql11query.php';
class Erfurt_Sparql_ParserQuery11Test extends Erfurt_TestCase
{
    ...
    {
		$parser = new Erfurt_Sparql_Parser_Sparql11query();
		try {
