...
require_once 'Erfurt/Store/Adapter/Arc.php';

class Erfurt_Store_Adapter_ArcTest extends Erfurt_TestCase
{
    public $fixture = null;
    private $config = null;
    ...
    public function setUp()
    {
        ...
        $this->fixture = new Erfurt_Store_Adapter_Arc($this->config);
    }
    
    public function testInstantiation()
    {
        $this->assertSame('Erfurt_Store_Adapter_Arc', get_class($this->fixture));
    }
    
    public function testListTables()
    {
        
        $this->assertEquals(true, in_array($this->config['store'].'_g2t', $this->fixture->listTables()));
        $this->assertEquals(true, in_array($this->config['store'].'_id2val', $this->fixture->listTables()));
        $this->assertEquals(true, in_array($this->config['store'].'_o2val', $this->fixture->listTables()));
        $this->assertEquals(true, in_array($this->config['store'].'_s2val', $this->fixture->listTables()));
        $this->assertEquals(true, in_array($this->config['store'].'_setting', $this->fixture->listTables()));
        $this->assertEquals(true, in_array($this->config['store'].'_triple', $this->fixture->listTables()));
    }
