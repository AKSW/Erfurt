...
return array(
    ...
    'optional' => array(
        'query'           => 'PREFIX dc: <http://purl.org/dc/elements/1.1/> PREFIX foaf: <http://xmlns.com/foaf/0.1/>
                              ...
                              SELECT ?var4 ?var8 ?var10 WHERE { ?var5 dbpedia-owl:thumbnail ?var4 . ?var5 rdf:type dbpedia-owl:Person . ?var5 rdfs:label %%var%% . ?var5 foaf:page ?var8 . OPTIONAL { ?var5 foaf:homepage ?var10 .} . }',
    ...
    'union' => array(
        'query'           => 'PREFIX dc: <http://purl.org/dc/elements/1.1/>
                              ...
                              PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
                              PREFIX skos: <http://www.w3.org/2004/02/skos/core#>
                              SELECT ?var5 ?var6 ?var9 ?var8 ?var4 WHERE { { %%var%% ?var5 ?var6 . ?var6 foaf:name ?var8 . } UNION { ?var9 ?var5 %%var%% ; foaf:name ?var4 . } }',
        'auxiliary_query' => 'PREFIX dc: <http://purl.org/dc/elements/1.1/>
                              PREFIX : <http://dbpedia.org/resource/>
                              PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>
                              PREFIX dbpedia2: <http://dbpedia.org/property/>
    ...
    'union,distinct' => array(
        'query'           => 'PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>
                              ...
                              PREFIX foaf: <http://xmlns.com/foaf/0.1/>
                              PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
                              SELECT DISTINCT ?var3 ?var4 ?var5 WHERE { { ?var3 dbpp:series %%var1%% ; foaf:name ?var4 ; rdfs:comment ?var5 ; rdf:type %%var0%% . } UNION { ?var3 dbpp:series ?var8 . ?var8 dbpp:redirect %%var1%% . ?var3 foaf:name ?var4 ; rdfs:comment ?var5 ; rdf:type %%var0%% . } }',
    ...
    'filter,distinct' => array(
        'query'           => 'PREFIX owl: <http://www.w3.org/2002/07/owl#>
                              ...
                              PREFIX dbpedia: <http://dbpedia.org/>
                              PREFIX skos: <http://www.w3.org/2004/02/skos/core#>
                              SELECT DISTINCT ?var3 ?var5 ?var7 WHERE { ?var3 rdf:type <http://dbpedia.org/class/yago/Company108058098> . ?var3 dbpedia2:numEmployees ?var5 FILTER ( xsd:integer(?var5) >= %%var%% ) . ?var3 foaf:homepage ?var7 . }',
    ...
    'union,filter' => array(
        'query'           => 'PREFIX owl: <http://www.w3.org/2002/07/owl#>
                              ...
                              PREFIX dbpedia: <http://dbpedia.org/>
                              PREFIX skos: <http://www.w3.org/2004/02/skos/core#>
                              SELECT ?var2 ?var4 WHERE { { ?var2 rdf:type %%var1%%. ?var2 dbpedia2:population ?var4. FILTER (xsd:integer(?var4) > %%var0%%) } UNION { ?var2 rdf:type %%var1%%. ?var2 dbpedia2:populationUrban ?var4. FILTER (xsd:integer(?var4) > %%var0%%) } }',
        'auxiliary_query' => 'PREFIX owl: <http://www.w3.org/2002/07/owl#>
                              PREFIX xsd: <http://www.w3.org/2001/XMLSchema#>
                              PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>
                              PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
    ...
    'union,optional,distinct' => array(
        'query'           => 'PREFIX owl: <http://www.w3.org/2002/07/owl#>
                              ...
                              PREFIX umbelBus: <http://umbel.org/umbel/sc/Business>
                              PREFIX umbelCountry: <http://umbel.org/umbel/sc/IndependentCountry>
                              SELECT distinct ?var3 ?var4 ?var2 WHERE { {%%var%% dbpedia2:subsid ?var3 OPTIONAL{?var2 %%var%% dbpedia2:parent} OPTIONAL{%%var%% dbpedia2:divisions ?var4}} UNION {?var2 %%var%% dbpedia2:parent OPTIONAL{%%var%% dbpedia2:subsid ?var3} OPTIONAL{%%var%% dbpedia2:divisions ?var4}} UNION {%%var%% dbpedia2:divisions ?var4 OPTIONAL{%%var%% dbpedia2:subsid ?var3} OPTIONAL{?var2 %%var%% dbpedia2:parent}} }',
        'auxiliary_query' => 'PREFIX owl: <http://www.w3.org/2002/07/owl#>
                              PREFIX xsd: <http://www.w3.org/2001/XMLSchema#>
                              PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>
                              PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
    ...
    'filter,lang,distinct' => array(
        'query'           => "PREFIX dc: <http://purl.org/dc/elements/1.1/>
                              ...
                              PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
                              PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>
                              SELECT DISTINCT ?var5 WHERE { ?var2 rdf:type dbpedia-owl:Person . ?var2 dbpedia-owl:nationality ?var4 . ?var4 rdfs:label ?var5 . ?var2 rdfs:label %%var%% . FILTER (lang(?var5) = 'en') }",
        'auxiliary_query' => "PREFIX dc: <http://purl.org/dc/elements/1.1/>
                              PREFIX foaf: <http://xmlns.com/foaf/0.1/>
                              PREFIX xsd: <http://www.w3.org/2001/XMLSchema#>
                              PREFIX space: <http://purl.org/net/schemas/space/>
    ...
    'union,filter,lang' => array(
        'query'           => "PREFIX owl: <http://www.w3.org/2002/07/owl#>
                              ...
                              PREFIX dbpedia: <http://dbpedia.org/>
                              PREFIX skos: <http://www.w3.org/2004/02/skos/core#>
                              SELECT * WHERE {{ %%var%% rdfs:comment ?var0. FILTER (lang(?var0) = 'en')} UNION {%%var%% foaf:depiction ?var1} UNION {%%var%% foaf:homepage ?var2}}",
        'auxiliary_query' => "PREFIX rdfs:<http://www.w3.org/2000/01/rdf-schema#>
                              PREFIX foaf: <http://xmlns.com/foaf/0.1/>
                              PREFIX : <http://dbpedia.org/resource/>
                              PREFIX dbpedia2: <http://dbpedia.org/property/>
    ...
    'optional,filter,lang' => array(
        'query'           => "PREFIX owl: <http://www.w3.org/2002/07/owl#>
                              ...
                              PREFIX dbpedia: <http://dbpedia.org/>
                              PREFIX skos: <http://www.w3.org/2004/02/skos/core#>
                              SELECT ?var6 ?var8 ?var10 ?var4 WHERE { ?var4 skos:subject %%var%% . ?var4 foaf:name ?var6 . OPTIONAL { ?var4 rdfs:comment ?var8 . FILTER (LANG(?var8) = 'en') . } OPTIONAL { ?var4 rdfs:comment ?var10 . FILTER (LANG(?var10) = 'de') . } }",
        'auxiliary_query' => "PREFIX owl: <http://www.w3.org/2002/07/owl#>
                              PREFIX xsd: <http://www.w3.org/2001/XMLSchema#>
                              PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>
                              PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
    ...
    'filter,regex,distinct,str' => array(
        'query'           => "PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>
                              PREFIX dbo: <http://dbpedia.org/ontology/>
                              PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
                              SELECT DISTINCT ?var2 ?var3 WHERE { ?var2 rdf:type %%var%% ; rdfs:label ?var3 . FILTER regex(str(?var3), 'pes', 'i') }",
        'auxiliary_query' => "PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>
                              PREFIX dbo: <http://dbpedia.org/ontology/>
                              PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
    ...
    'union,filter,lang,distinct' => array(
        'query'           => "PREFIX dc: <http://purl.org/dc/elements/1.1/>
                              ...
                              SELECT DISTINCT ?var2 ?var3 { {?var2 <http://www.w3.org/2004/02/skos/core#subject> %%var%%.} UNION {?var2 <http://www.w3.org/2004/02/skos/core#subject> <http://dbpedia.org/resource/Category:Prefectures_in_France>.} UNION {?var2 <http://www.w3.org/2004/02/skos/core#subject> <http://dbpedia.org/resource/Category:German_state_capitals>.} ?var2 <http://www.w3.org/2000/01/rdf-schema#label> ?var3. FILTER (lang(?var3)='fr') }",
        'auxiliary_query' => "PREFIX dc: <http://purl.org/dc/elements/1.1/>
                              PREFIX dct: <http://purl.org/dc/terms/>
                              PREFIX map: <file:/home/moustaki/work/motools/musicbrainz/d2r-server-0.4/mbz_mapping_raw.n3#>
                              PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>
    ...
    '3-TriplePatterns' => array(
        'query'           => 'PREFIX dc: <http://purl.org/dc/elements/1.1/>
                              ...
                              PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
                              PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>
                              SELECT ?var4 WHERE { ?var2 rdf:type dbpedia-owl:Person . ?var2 rdfs:label %%var%% . ?var2 foaf:page ?var4 . }',
        'auxiliary_query' => 'PREFIX dc: <http://purl.org/dc/elements/1.1/>
                              PREFIX foaf: <http://xmlns.com/foaf/0.1/>
                              PREFIX xsd: <http://www.w3.org/2001/XMLSchema#>
                              PREFIX space: <http://purl.org/net/schemas/space/>
