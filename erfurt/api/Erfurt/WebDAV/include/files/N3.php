...
//	if(count($sub_array) ==3) 
//		$sub= $sub_array[0].".n3";
//	else 
//		$sub = $sub_array[0];
	$subname =rtrim($this->displayname2iri(substr($uriResource,0,-3)));
...
//	$querystring= "SELECT ?y ?z WHERE { <$subname> ?y ?z }";            	
//  	$result = $this -> Erfurt_selectedModel -> sparqlQuery($querystring);
...
//N3-Serializer, der das ganze Modell anschlieп·б╘Б∙╚nd serialisiert					
	$n3serializer = new N3Serializer();
	echo $n3serializer -> serialize($m);
?>