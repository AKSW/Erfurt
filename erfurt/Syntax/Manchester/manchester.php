...
*/
 ...
 /*  21 */ "list ::= instExpr",
  ...
  array( 'lhs' => 25, 'rhs' => 1 ),
    ...
    */
#line 36 "./manchester.y"
    function yy_r0(){
		print_r($this->yystack[$this->yyidx + 0]->minor->/*toManchesterSyntaxString*/generateRDF()->writeAsHtmlTable());    }
