 ...
 * @version $Id: StringWriterXMLImpl.php 1010 2007-06-03 13:11:24Z p_frischmuth $
 */
class Erfurt_Syntax_StringWriterXMLImpl implements Erfurt_Syntax_StringWriterInterface {
	...
	public function startDocument() {
		...
		$this->writeComment(EF_SERIALIZER_AD);
		$this->linefeed(2);
	...
	public function startElement($ns, $local) {
		...
		if ($this->wasComment === true) $this->wasComment = false;
	 ...
	 */
	private function linefeed($count = 1) {
	 ...
	 * @param string $local
	 */
	private function writeQName($ns, $local) {
