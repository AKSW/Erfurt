<?php
    ...
    define("OWL_ONPROPERTY", OWL_NS . 'onProperty');
    define("OWL_ONCLASS", OWL_NS . 'onClass');
    define("OWL_ONDATARANGE", OWL_NS . 'onDataRange');
    define("RDFS_DATATYPE", RDFS_NS . 'Datatype');
