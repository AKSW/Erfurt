...
*   @package sparql
*/
class Erfurt_Sparql_EngineDb_ResultConverter
{
    /**
    ...
    */
    public static function convertFromDbResults($arRecordSets, $engine, $resultform = false)
    {
        if (is_object($resultform)) {
            if ($resultform instanceof Erfurt_Sparql_EngineDb_ResultRenderer) {
