...
*   @package sparql
*/
class Erfurt_Sparql_EngineDb_ResultRenderer_RapAdodb_Plain implements Erfurt_Sparql_EngineDb_ResultRenderer {
    ...
    */
    protected function createStatementFromDbRecordSetPart($dbRecordSet, $strVarBase)
    {
    ...
    */
    protected function createSubjectFromDbRecordSetPart($dbRecordSet, $strVarBase, $strVar)
    {
        $strVarName = (string)$strVar;
    ...
    */
    protected function createPredicateFromDbRecordSetPart($dbRecordSet, $strVarBase, $strVar)
    {
        $strVarName = (string)$strVar;
        if ($dbRecordSet->fields[$strVarBase . '.' . $this->sg->arVarAssignments[$strVarName]['sql_value']] === null) {
            //FIXME: should be NULL, but doesn't pass test
    ...
    */
    protected function createObjectFromDbRecordSetPart($dbRecordSet, $strVarBase, $strVar)
    {
        $strVarName = (string)$strVar;
        if ($dbRecordSet->fields[$strVarBase . '.' . $this->sg->arVarAssignments[$strVarName]['sql_value']] === null) {
            //FIXME: should be NULL, but doesn't pass test
