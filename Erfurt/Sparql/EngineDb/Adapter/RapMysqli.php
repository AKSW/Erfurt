<?php
require_once 'Erfurt/Sparql/EngineDb/Offsetter/Adapter/RapMysqli.php';
...
*   @package sparql
*/
class Erfurt_Sparql_EngineDb_Adapter_RapMysqli {
    ...
    */
    public function queryModel(Erfurt_Sparql_Query $query, $resultform = 'plain') {
        ...
        switch ($resultform) {
            case 'xml':
                require_once 'Erfurt/Sparql/EngineDb/ResultRenderer/RapMysqli/Xml.php';
                $this->rc = new Erfurt_Sparql_EngineDb_ResultRenderer_RapMysqli_Xml();
                break;
            case 'plain':
            default:
                require_once 'Erfurt/Sparql/EngineDb/ResultRenderer/RapMysqli/Plain.php';
                $this->rc = new Erfurt_Sparql_EngineDb_ResultRenderer_RapMysqli_Plain();
        }
