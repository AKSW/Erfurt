<?php
require_once 'Erfurt/Sparql/EngineDb/Offsetter/Adapter/RapAdodb.php';
require_once 'Erfurt/Sparql/EngineDb/QuerySimplifier.php';
require_once 'Erfurt/Sparql/EngineDb/ResultConverter.php';
...
*   @package sparql
*/
class Erfurt_Sparql_EngineDb_Adapter_RapAdodb {
    ...
    */
    public function __construct($dbConn, $arModelIds = null) {
    ...
    */
    public function queryModel(Erfurt_Sparql_Query $query, $resultform = false) {
        ...
        $this->sg = new Erfurt_Sparql_EngineDb_SqlGenerator_Adapter_Rap($this->query, $this->arModelIds);
        $this->rc = new Erfurt_Sparql_EngineDb_ResultConverter($this->query, $this->sg, $this);
        $this->ts = new Erfurt_Sparql_EngineDb_TypeSorter     ($this->query, $this->_store);
        ...
        return
            Erfurt_Sparql_EngineDb_ResultConverter::convertFromDbResults(
                $this->queryMultiple(
    ...
    */
    protected function queryMultiple($arSqls)
    {
        ...
        if ($arSM['limit'] === null && $arSM['offset'] === null) {
            ...
            $offsetter = new Erfurt_Sparql_EngineDb_Offsetter_Adapter_RapAdodb($this->dbConn, $this->query);
