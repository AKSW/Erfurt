<?php
// $ANTLR 3.1.3 “ˆŽ 06, 2009 18:28:01 src/Erfurt_Sparql_Parser_Sparql10_Sparql10.g 2010-05-16 20:22:26
...
class Erfurt_Sparql_Parser_Sparql10_Sparql10Parser extends AntlrParser {
    ...
    static $FOLLOW_query10_in_parse63;
    static $FOLLOW_EOF_in_parse65;
    ...
    public function parse(){
        ...
        try {
            ...
            {
            $this->pushFollow(self::$FOLLOW_query10_in_parse63);
            $query101=$this->query10();

            $this->state->_fsp--;

            $this->match($this->input,$this->getToken('EOF'),self::$FOLLOW_EOF_in_parse65); 
...
Erfurt_Sparql_Parser_Sparql10_Sparql10Parser::$FOLLOW_query10_in_parse63 = new Set(array());
Erfurt_Sparql_Parser_Sparql10_Sparql10Parser::$FOLLOW_EOF_in_parse65 = new Set(array(1));
