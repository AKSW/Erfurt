...
$Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA15 = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA15_static();

class Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA15 extends DFA {

    public function __construct($recognizer) {
        global $Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA15;
        $DFA = $Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA15;
...
function Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA30_static(){
...
$Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA30 = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA30_static();

class Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA30 extends DFA {

    public function __construct($recognizer) {
        global $Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA30;
        $DFA = $Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA30;
        $this->recognizer = $recognizer;
...
function Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA33_static(){
    $eot = array(1, 65535, 6, 8, 3, 65535);
    $eof = array(10, 65535);
    $min = array(7, 45, 3, 65535);
    $max = array(7, 65533, 3, 65535);
...
$Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA33 = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA33_static();

class Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA33 extends DFA {

    public function __construct($recognizer) {
        global $Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA33;
        $DFA = $Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA33;
        $this->recognizer = $recognizer;
...
$Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA36 = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA36_static();

class Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA36 extends DFA {

    public function __construct($recognizer) {
        global $Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA36;
        $DFA = $Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11_DFA36;
        $this->recognizer = $recognizer;
...
class Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11 extends AntlrLexer {
    static $PREFIX=22;
    static $EXPONENT=77;
    static $SILENT=12;
    ...
    // delegators
    /**
    * @param Erfurt_Sparql_Parser_Sparql11_UpdateLexer $gErfurt_Sparql_Parser_Sparql11_Update
    */
    ...
    */
    ...
    function mDATA(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DATA;
    ...
    function mLOAD(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$LOAD;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mCLEAR(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$CLEAR;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mDROP(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DROP;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mUNSAID(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$UNSAID;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mCOUNT(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$COUNT;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mDEFINE(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFINE;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mCONSTRUCT(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$CONSTRUCT;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mNAMED(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$NAMED;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mBY(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$BY;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mASC(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$ASC;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mAS(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$AS;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mSAMETERM(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$SAMETERM;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mISIRI(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$ISIRI;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mISURI(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$ISURI;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mIRI_REF(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$IRI_REF;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mVAR1(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$VAR1;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
            $v=null;
    ...
    function mVAR2(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$VAR2;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
            $v=null;
    ...
    function mDOUBLE(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DOUBLE;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mINTEGER_POSITIVE(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$INTEGER_POSITIVE;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
            $n=null;
    ...
    function mDOUBLE_POSITIVE(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DOUBLE_POSITIVE;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
            $n=null;
    ...
    function mDECIMAL_NEGATIVE(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DECIMAL_NEGATIVE;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
            $n=null;
    ...
    function mDOUBLE_NEGATIVE(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DOUBLE_NEGATIVE;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
            $n=null;
    ...
    function mSTRING_LITERAL_LONG1(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$STRING_LITERAL_LONG1;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mSTRING_LITERAL_LONG2(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$STRING_LITERAL_LONG2;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mWS(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$WS;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
    ...
    function mBLANK_NODE_LABEL(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$BLANK_NODE_LABEL;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
            $t=null;
    ...
    function mASTERISK(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$ASTERISK;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
            // Tokenizer11.g:658:3: ( '*' ) 
            // Tokenizer11.g:659:3: '*' 
            {
    ...
    function mEQUAL(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$EQUAL;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
            // Tokenizer11.g:678:3: ( '=' ) 
            // Tokenizer11.g:679:3: '=' 
            {
    ...
    function mLESS_EQUAL(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$LESS_EQUAL;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
            // Tokenizer11.g:703:3: ( '<=' ) 
            // Tokenizer11.g:704:3: '<=' 
            {
    ...
    function mQUESTION_MARK_LABEL(){
        try {
            $_type = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$QUESTION_MARK_LABEL;
            $_channel = Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11::$DEFAULT_TOKEN_CHANNEL;
            // Tokenizer11.g:733:3: ( '?' ) 
            // Tokenizer11.g:734:3: '?' 
            {
    ...
    function mTokens(){
        ...
        switch ($alt36) {
            ...
            case 41 :
                ...
                {
                $this->gErfurt_Sparql_Parser_Sparql11_Update->mA(); 
