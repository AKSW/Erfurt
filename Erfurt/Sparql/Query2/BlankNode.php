 ...
 * @version    $Id$
 */
class Erfurt_Sparql_Query2_BlankNode implements Erfurt_Sparql_Query2_GraphTerm{ //TODO 1. may not appear in two different graphs. 2. an anon bn should only be used once (fix in ...GraphPattern)
    protected $name = '';
